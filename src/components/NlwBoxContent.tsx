    ...
    return (
        <div className="flex justify-between mx-[150px] mt-20">
            <div className="h-[371px]">
                ...
                <a onClick={routeChange} className="cursor-pointer"><img className="relative z-1 -top-[340px] left-0.5 w-[495px] h-[310px] overflow-hidden" src={thumbnailPath} alt="nlw" /></a>
            </div>
